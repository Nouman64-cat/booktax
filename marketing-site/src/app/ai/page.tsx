...
export default function AiPage() {
    return (
        <main className="min-h-screen bg-white dark:bg-gray-900 selection:bg-primary-500 selection:text-white">
            <Hero />
            <VideoSection />
            <Features />
            ...
            <section className="py-20 relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-r from-primary-600 to-primary-700 opacity-90 dark:opacity-80" />
                ...
                <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Link href="https://ai.Booktax.com/register">
                            <button className="px-8 py-4 bg-white text-primary-600 font-bold rounded-lg hover:bg-primary-50 transition-colors shadow-lg hover:shadow-xl hover:scale-105 transform duration-200">
                                Get Started Now
                            </button>
                        </Link>
